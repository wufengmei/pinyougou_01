...
app.service("allSeckillOrderListService", function ($http) {
    ...
    this.search = function (page, rows, searchEntity) {
        return $http.post("../order/Seckillsearch.do?page=" + page + "&rows=" + rows, searchEntity);
    };
    ...
    this.updateStatus = function (selectedIds, status) {
        return $http.get("../order/updateStatus.do?ids=" + selectedIds + "&status=" + status);
    };
